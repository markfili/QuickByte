 ...
 * managing HTTP requests and responses with AsyncHttpClient
 */
public class QuickAsyncHttpClient {

    private static final String BASE_URL = "http://demo6389157.mockable.io/";
